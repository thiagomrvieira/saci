...
/**
 * Central facade for managing request data collection.
 *
 * This class provides a simplified interface for working with
 * the collector architecture, managing the lifecycle of data
 * collection across a request/response cycle.
 */
class RequestResources
{
    ...
    /**
     * Convert collected data to array format for rendering.
